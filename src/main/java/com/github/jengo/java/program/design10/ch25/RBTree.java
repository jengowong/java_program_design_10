...
public class RBTree<E extends Comparable<E>> extends BinaryTree<E> {
     ...
     */
    private void fixDoubleRed(RBTreeNode<E> u,
                              RBTreeNode<E> v,
     ...
     */
    private void restructureRecolor(RBTreeNode<E> a,
                                    RBTreeNode<E> b,
                                    RBTreeNode<E> c,
                                    RBTreeNode<E> w,
                                    RBTreeNode<E> parentOfw) {
        if (parentOfw == null) {
            root = b;
     ...
     */
    private void fixDoubleBlack(RBTreeNode<E> grandparent,
                                RBTreeNode<E> parent,
                                RBTreeNode<E> db,
                                ArrayList<TreeNode<E>> path,
                                int i) {
     ...
     */
    protected static class RBTreeNode<E extends Comparable<E>> extends BinaryTree.TreeNode<E> {
